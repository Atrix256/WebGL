...
This technique does have applications to vector graphics, but they are pretty limited admitedly.  The main reason for the limitation is that this technique is good at calculating the point on a curve at time $t$, but when using curves in vector graphics situations, you usually do not know the time $t$ that you want to know the curve point for, and it is usually difficult to find it.

TODO: mention loop and blinn's paper as an example of how it avoids the problem of finding the time 4.
...
TODO: any play here with lobes and encoding curves in polar form?
