...
\begin{figure}
    ...
    \caption{Rational Bezier spline vs glsl sin() function.  Sin() values in grey on top of the Bezier spline in red.  Red pixels show where the values do not match. }
