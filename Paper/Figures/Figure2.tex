...
\begin{document}
	...
	\begin{figure}
		\begin{tikzpicture}[x=12.5cm,y=4.25cm]
		    ...
		    \node[anchor=south west,inner sep=0] at (0.125cm,0.125cm) {\includegraphics[width=4cm,height=4cm]{Figure2Texture.png}};
		    \node[anchor=south west,inner sep=0] at (4.25cm,0.125cm) {\includegraphics[width=4cm,height=4cm]{Figure2Bilinear.png}};
		    \node[anchor=south west,inner sep=0] at (8.375cm,0.125cm) {\includegraphics[width=4cm,height=4cm]{Figure2Curves.png}};
